package com.gaajula.sample.customer.dao.impl;
...
import com.gaajula.sample.customer.model.CustomerParameterizedRowMapper;
...
public class SimpleJdbcCustomerDAO extends SimpleJdbcDaoSupport implements
	...
	public void insertBatch(final List<Customer> customers) {
		...
		for (Customer cust : customers) {
			parameters.add(new Object[] { cust.getCustId(), cust.getName(),
					cust.getAge() });
		}
	...
	public Customer findByCustomerId(int custId) {
		...
		Customer customer = getSimpleJdbcTemplate().queryForObject(sql,
				new CustomerParameterizedRowMapper(), custId);
	...
	public String findCustomerNameById(int custId) {
		...
		String name = getSimpleJdbcTemplate().queryForObject(sql, String.class,
				custId);
